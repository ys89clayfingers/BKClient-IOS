#
# Be sure to run `pod lib lint bkclient-ios.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'bkclient-ios'
  s.version          = '0.1.0'
  s.summary          = 'A short description of bkclient-ios.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'bkclient-ios/Classes/**/*'
  
  # s.resource_bundles = {
  #   'bkclient-ios' => ['bkclient-ios/Assets/*.png']
  # }
